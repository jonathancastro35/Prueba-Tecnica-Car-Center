...
export default class factura1 extends Component {
                    ...
                    this.state.clientes.map(cor => (
                        ...
                        <div className="card">
                            ...
                            <div className="card-header d-flex justify-content-between">
                             <h5><b>Conocer los vehiculos Del Cliente</b>:{cor.documento}</h5>
                             
                             <Link className="btn btn-secondary" to={"/BuscarVehiculosCliente/" + cor.documento}>
                                Buscar
                             </Link>
